...
This project allow to determine tree micro-habitat dynamic model. It is
based on survivorship analysis and performed by Bayesian inference.
This project use the R software and some rpackage (see Scripts/README for more 
informations).

--------
The project is composed of different folder : 
